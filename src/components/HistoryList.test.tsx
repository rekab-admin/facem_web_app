...
const MEASUREMENTS: Measurement[] = [
  {
    ...
    points: [],
    mmPerUnit: 250,
    dimensions: { pupillaryDistanceMm: 60, faceWidthMm: 140, bridgeWidthMm: 12, templeLengthMm: 100 },
  ...
  },
  {
    ...
    points: [],
    mmPerUnit: 250,
    dimensions: { pupillaryDistanceMm: 58, faceWidthMm: 125, bridgeWidthMm: 11, templeLengthMm: 95 },
